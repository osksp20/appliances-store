...
public class FinanciacionesService extends GenericService<Financiacion> {
	...
	protected void validaNuevoElemento(Financiacion financiacion) throws Exception {
		if(financiacion.getId() != null) {
			throw new Exception("El ID de la financiación no puede estar informado");
		}
	}
	...
	protected void validaElementoAModificar(Financiacion financiacion) throws Exception {
		if(financiacion.getId() == null) {
			throw new Exception("No se ha informado el ID de la financiación a eliminar");
		}
		...
		if(venta == null) {
			throw new Exception("La venta indicada para la financiación no existe");
		}
		...
		if(cuota > cuotaMax) {
			throw new Exception("La cuota de la financiación excede del máximo permitido para este cliente");
		}
	}
